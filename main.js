  ...
  document.getElementById("selected-gems-text").classList.add('gemstext');
      ...
      audiobtnclick.play();
          document.getElementById("main2").style.display="none";
              ...
              function UserTimer() {
                if (linestep==1){
                  document.getElementById("loading-step").innerHTML="جارى التحميل...";
                      document.getElementById("pro-bar").classList.add('probar40');
      
                }else if(linestep==2){
                      document.getElementById("pro-bar").classList.add('probar60');
                  document.getElementById("loading-step").innerHTML='ارسال <span style="font-size: 24px;font-weight: 900;">'+gemsvalue+'</span> جيجا الى  <span style="font-size: 24px;font-weight: 900;">' + name +'</span>' ;
              ...
              var linestep=1;
                function UserTimerAddgems3() {
                  ...
                  document.getElementById("loading-step").innerHTML="جارى الارسال...";
                  document.getElementById("pro-bar").classList.add('probar40-75');
              }else if(linestep==4){
                document.getElementById("loading-step").innerHTML="جارى تحميل الخطوة الاخيرة...";
      ...
      document.getElementById("lastStep-gems").innerHTML=gemsvalue + "جيجا";
          document.getElementById("lastStep-name").innerHTML=name;
      document.getElementById("lastStep-gems2").innerHTML=gemsvalue;
          document.getElementById("lastStep-name2").innerHTML="جيجا";
...
findlink[0].href = "https://www.google.com";